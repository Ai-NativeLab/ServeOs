...
ALTER TYPE "public"."payment_status" ADD VALUE 'pending_verification' BEFORE 'partially_paid';--> statement-breakpoint
...
CREATE UNIQUE INDEX "tenant_offline_methods_tenant_type_unique" ON "tenant_offline_methods" USING btree ("tenant_id","type");--> statement-breakpoint
...
CREATE UNIQUE INDEX "invoices_one_outstanding_per_tenant" ON "invoices" USING btree ("tenant_id") WHERE status in ('open','pending_verification');--> statement-breakpoint
