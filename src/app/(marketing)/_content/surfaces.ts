...
export const SURFACES: Localized<SurfacesContent> = {
  ar: {
    eyebrow: "المنتج",
    heading: "هكذا يبدو العمل من الداخل.",
    bands: {
      storefront: {
        title: "المتجر",
        ...
        callout: "دون تطبيق يثبّته العميل",
      },
      dashboard: {
        title: "لوحة التحكم",
        ...
        callout: "تصل الطلبات فور إنشائها",
      },
      pos: {
        title: "نقطة البيع",
    ...
    whatsapp: {
      ...
      chat: [
        ...
        { from: "shop", text: "تمّ — الإجمالي ٢١٥ ج.م" },
      ],
    },
  },
  en: {
