...
export const pharmacy: Localized<TradeContent> = {
  ar: {
    ...
    subhead:
      "رفوفك أونلاين وكاونترك ملتزم — بيع الأدوية اللي من غير وصفة من متجرك، واصرف الوصفة على الكاونتر، ولا تبيعش علبة منتهية الصلاحية خالص. لوحة واحدة للمخزون والتشغيلات والمبيعات.",
