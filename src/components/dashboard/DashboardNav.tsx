...
import { Home, Receipt, Utensils, Store, Image, Settings, BarChart3, ShieldCheck, Users } from "lucide-react";
import { cn } from "@/lib/utils";
import { LogoMark } from "@/components/brand/LogoMark";
import type { NavItem } from "./nav-items";

const ICONS: Record<string, React.ComponentType<{ className?: string; strokeWidth?: number }>> = {
  home: Home, analytics: BarChart3, receipt: Receipt, utensils: Utensils, store: Store, image: Image, settings: Settings, audit: ShieldCheck, customers: Users,
};
