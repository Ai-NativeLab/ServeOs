...
export function onboardingSteps(input: OnboardingInput): OnboardingStep[] {
  return [
    ...
    { key: "hours", label: "Set opening hours", href: "/dashboard/settings/fulfillment", done: input.hasOpeningHours },
    { key: "live", label: "Start accepting orders", href: "/dashboard/settings/fulfillment", done: input.acceptingOrders },
  ];
}
